...
colPerc(table1)
```
%9.3% of the people who got aids ended up taking the drug, whereas 40.7% took the placebo.
...
fisher.test(table1)
```
Since our p values for our data are all significantly low figures, we can reject our null hypothesis. We can come to a conclusion that the drug is ineffective.
